...
impl ResultMap {
    ...
    //returns true only if made an improvement
    pub fn try_put_trial_based(&mut self, new_entry: Message, trial_no: u64) -> PutResult {
    ...
    //returns true only if made an improvement
    pub fn try_put_trial_based_config(&mut self, new_entry: Message, trial_no: u64, config: &Config, method_code: u8) -> PutResult {
        ...
        for row_i in 0.. params::MAP_ROWS{
            for col_i in 0.. params::MAP_COLS{
                if let Some(genome) = self.prog_map.get_mut(&(row_i, col_i)) {
                    let fit = match genome.cv_fit {
                        Some(cv_fit) => cv_fit,
                        None => progSystem::eval::eval_program_cv(genome, &data),
                    };
                    genome.cv_fit = Some(fit);
                    ave += fit as f64;
                    count += 1.0;
                    if fit > best {best=fit;}
                    if fit < worst {worst=fit;}
...
fn get_adjusted_fit(prog: &Program, trial_no: u64)->f32{
    ...
    let min = -1.5/params::DATA_SET_SIZE as f64;
    let max = 1.5/params::DATA_SET_SIZE as f64;
...
fn get_adjusted_fit_config1(prog: &Program, trial_no: u64, config: &Config)->f32{
    ...
    let n_waves = 1.5;
    let min_penalty = -5.0/params::DATA_SET_SIZE as f64;
    let max_penalty = 5.0/params::DATA_SET_SIZE as f64;
...
fn get_adjusted_fit_config2(prog: &Program, trial_no: u64, config: &Config)->f32{
    ...
    let n_waves = 2.0;
    let min_penalty = -1.5/params::DATA_SET_SIZE as f64;
    let max_penalty = 1.5/params::DATA_SET_SIZE as f64;
...
fn get_adjusted_fit_config5(prog: &Program, trial_no: u64, config: &Config)->f32{
    ...
    let n_waves = 1.5;
    let min_penalty = 0.0/params::DATA_SET_SIZE as f64;
    let max_penalty = 3.0/params::DATA_SET_SIZE as f64;
...
fn get_adjusted_fit_config6(prog: &Program, trial_no: u64, config: &Config)->f32{
    ...
    let n_waves = 1.5;
    let min_penalty = -1.5/params::DATA_SET_SIZE as f64;
    let max_penalty =4.5 /params::DATA_SET_SIZE as f64;
...
fn get_adjusted_fit_config7(prog: &Program, trial_no: u64, config: &Config)->f32{
    ...
    let mut penalty = 0.5/params::DATA_SET_SIZE as f64;
    penalty *= prog.get_effective_len(0) as f64;
...
fn get_adjusted_fit_config8(prog: &Program, trial_no: u64, config: &Config)->f32{
    ...
    let mut penalty = 1.5/params::DATA_SET_SIZE as f64;
    penalty *= prog.get_effective_len(0) as f64;
...
fn get_adjusted_fit_config10(prog: &Program, trial_no: u64, config: &Config)->f32{
    ...
    let n_waves_len = 3.5;
    let min_penalty__len = -1.5/params::DATA_SET_SIZE as f64;
    let max_penalty_len = 1.5/params::DATA_SET_SIZE as f64;
    ...
    let n_waves = 3.5;
    let min_bonus = 0.0/params::DATA_SET_SIZE as f64;
    let max_bonus = 1.5/params::DATA_SET_SIZE as f64;
...
fn get_adjusted_fit_config11(prog: &Program, trial_no: u64, config: &Config)->f32{
    ...
    let n_waves_len = 3.5;
    let min_penalty__len = -0.5/params::DATA_SET_SIZE as f64;
    let max_penalty_len = 2.5/params::DATA_SET_SIZE as f64;
    ...
    let n_waves = 3.5;
    let min_bonus = 0.0/params::DATA_SET_SIZE as f64;
    let max_bonus = 4.5/params::DATA_SET_SIZE as f64;
...
fn get_adjusted_fit_config12(prog: &Program, trial_no: u64, config: &Config)->f32{
    ...
    let n_waves_len = 3.5;
    let min_penalty__len = -0.25/params::DATA_SET_SIZE as f64;
    let max_penalty_len = 1.5/params::DATA_SET_SIZE as f64;
